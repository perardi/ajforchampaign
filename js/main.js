...
var dark = header.offsetTop;

// Add the sticky class to the header when you reach its scroll position. Remove "sticky" when you leave the scroll position
function myFunction() {
  if (window.pageYOffset > dark) {
...
var fontA = new FontFaceObserver('sarabunregular');
var fontB = new FontFaceObserver('sarabun_extralightregular');
